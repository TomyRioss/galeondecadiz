...
export default function NewLibroPage() {
  ...
  return (
    <div className="flex flex-col gap-3 w-full pt-6 pb-12 px-4 md:px-8">
      ...
      {/* Two-column layout */}
      <form id="new-libro-form" onSubmit={handleSubmit} className="grid grid-cols-1 xl:grid-cols-3 gap-4">
        ...
        <div className="xl:col-span-2 flex flex-col gap-3">
          ...
          <section className="rounded-xl p-4 border-2" style={{ background: "linear-gradient(160deg,#ede4cb 0%,#ddd0b0 100%)", borderColor: "#B87333", boxShadow: "0 4px 24px rgba(26,58,92,0.08)" }}>
            <div className="flex items-center gap-2 mb-3">
              ...
              <span className="text-[0.6rem] tracking-[0.25em] uppercase font-semibold" style={{ color: "#B87333", fontFamily: "var(--font-cinzel, serif)" }}>Precios & Tipo</span>
            </div>
