    ...
    <div>
      <div className="flex items-center justify-between mb-8">
        ...
        <button
          ...
          onClick={() => {
            const csv = "Nombre,Correo,WhatsApp,Mensaje,Origen,Fecha\n";
      ...
      >
        ...
        >
          Los contactos registrados aparecerán aquí una vez que se apruebe la tabla <code>contact_requests</code> en Supabase (T38).
        </p>
      </div>
    </div>
  );
