...
const devocionales = [
  ...
  {
    slug: "novena-san-luis-bertran",
    titulo: "Novena Tradicional a San Luis Bertrán",
    subtitulo: "Novena de intercesión",
    autor: "Tradición católica",
    fecha: "Devoción mariana",
    tag: "Novena",
  },
  {
    slug: "oracion-nuestra-senora-chiquinquira",
    titulo: "Oración a Nuestra Señora de Chiquinquirá",
    subtitulo: "Devoción mariana",
    autor: "Fondo Editorial Galeona de Cádiz",
    fecha: "Fe y tradición",
    tag: "Oración",
  },
  {
    slug: "testimonios",
    titulo: "Testimonios",
    subtitulo: "Experiencias de fe y devoción",
    autor: "Comunidad Galeona",
    fecha: "Voces de la comunidad",
    tag: "Testimonios",
  },
];
